        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 py-8 sm:py-12">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold truncate">{SITE_CONFIG.name}</h3>
                <p className="text-xs sm:text-sm md:text-base text-gray-400">Moving & Packing</p>
              </div>
            </div>
            <p className="text-gray-300 text-xs sm:text-sm md:text-base leading-relaxed break-words">
              Professional moving and packing services in Addis Ababa, Ethiopia.
              We make your move stress-free and efficient.
            </p>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <ul className="space-y-1.5 sm:space-y-2">
              ...
              <li>
                <Link href="/about" className="text-gray-300 hover:text-white transition-colors text-sm sm:text-base py-1 block break-words" onClick={() => handleFooterLinkClick('Quick Links', 'About')}>
                  {t('nav.about')}
                </Link>
              </li>
              <li>
